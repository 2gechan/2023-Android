void main(List<String> args) {
  ...
  /// const 선언문은 겉보기는 final과 유사하게 한번 값을 할당(set)하면
  /// 다시 값을 변경(set) 할 수 없다.
  /// 또한, const 선언문은 함수의 return 값을 받을 수 없다.
  /// const 선언문은 코드가 실행되기 전에 확정적인 값만을 저장할 수 있다.
  ...
  /// sumNums(30, 40)는 run하기 전까지는 값을 알지 못하기 때문에 const에 저장할 수 없다.
  /// 어떻게 보면 final 보다 조건이 타이트한 상수라고 볼 수 있다.
